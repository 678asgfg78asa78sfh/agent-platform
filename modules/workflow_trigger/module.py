...
MODULE = {
    ...
    "settings": {
        ...
        "default_tts_voice": {"type": "string", "label": "TTS Stimme", "default": "ara"},
...
def start_tts_task(wf: dict[str, Any], config: dict[str, Any], assets: dict[str, Any], script_path: Path) -> None:
    ...
    params = {
        ...
        "voice": options.get("tts_voice") or config.get("default_tts_voice") or "ara",
...
def help_text() -> dict[str, Any]:
    return {
        ...
        "deepdive_video": [
            ...
            "3. LLM-Task normalisiert den Report zu VIDEO_ASSETS_JSON: gesprochenes Skript, Szenen, Routen, Shorts-Hooks.",
            ...
            "8. Erst wenn audio_path existiert, startet video_pipeline.briefing_video.",
